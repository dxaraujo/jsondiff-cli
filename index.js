...
program.command('init')
	...
	.requiredOption('-d, --dir <string>', 'Diretório onde o programa será executado', 'concal')
	.action((args) => {
		init(args)
	})
...
program.command('cws')
	...
	.requiredOption('-c, --cwsDir <string>', 'Diretório onde os arquivos serão gravados', 'cws')
	.action((args) => {
		cws(args)
	})
...
program.command('java')
	...
	.option('-c, --cwsDir <string>',  'Diretório onde os arquivos serão lidos', 'cws')
	.option('-j, --javaDir <string>', 'Diretório onde os arquivos serão gravados', 'java')
	.action((args) => {
		java(args)
	})
